$(document).ready(function() {
	...
	Backstretch Images
	==============================================*/
	$.backstretch('/Content/beach_11.jpg');/*header-bg changed to beach_1*/

	$('body').append('<img class="preload-image" src="/Content/beach_2.jpg" style="display:none;"/>');/*"contact-bg.jpg" changed to "beach_2.jpg"*/
	...
	$('#about').waypoint(function(direction){
		...
		if (direction=='down'){
		    $.backstretch('/Content/beach_2.jpg');/*"contact-bg.jpg" changed to "beach_2.jpg"*/
		}else{
		    $.backstretch('/Content/beach_11.jpg');/*header-bg changed to beach_1*/
		}
	});
